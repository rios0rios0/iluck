...
- refreshed `CLAUDE.md`, `.github/copilot-instructions.md`, and `.github/skills/code-review/SKILL.md` to record the `checks.yaml` rebase and changelog gate and fix the secret-hygiene example
